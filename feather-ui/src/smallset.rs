    ...
    SmallSet<N, T, SH, SI, LINEAR_THRESHOLD>
{
    ...
    #[inline]
    pub fn difference<'a, const N2: usize, S>(
        &'a self,
        other: &'a SmallSet<N2, T, S>,
    ) -> Difference<'a, N, N2, T, S> {
        Difference {
            iter: self.iter(),
            other,
        }
...
pub struct Iter<'a, const N: usize, T> {
    inner: small_map::Keys<'a, N, T, ()>,
}

impl<'a, const N: usize, T> Clone for Iter<'a, N, T>
where
    small_map::Keys<'a, N, T, ()>: Clone,
{
    #[inline]
    fn clone(&self) -> Self {
        Iter {
...
// Difference iterator
pub struct Difference<'a, const N1: usize, const N2: usize, T: 'a, S: 'a> {
...
impl<'a, const N1: usize, const N2: usize, T, S> Clone for Difference<'a, N1, N2, T, S>
where
    small_map::Keys<'a, N1, T, ()>: Clone,
{
    #[inline]
    fn clone(&self) -> Self {
        Difference {
...
impl<'a, const N1: usize, const N2: usize, T, S> Iterator for Difference<'a, N1, N2, T, S>
where
    T: Eq + Hash,
    S: BuildHasher,
{
...
impl<const N1: usize, const N2: usize, T, S> FusedIterator for Difference<'_, N1, N2, T, S>
where
    T: Eq + Hash,
    S: BuildHasher,
{
...
impl<'a, const N1: usize, const N2: usize, T, S> fmt::Debug for Difference<'a, N1, N2, T, S>
where
    T: fmt::Debug + Eq + Hash,
    S: BuildHasher,
    small_map::Keys<'a, N1, T, ()>: Clone,
