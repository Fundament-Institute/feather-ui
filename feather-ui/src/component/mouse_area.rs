...
/// Represents processed mouse events, transformed into more useful [`MouseAreaEvent::OnClick`],
/// [`MouseAreaEvent::OnDrag`], [`MouseAreaEvent::Hover`], etc. Generated by [`MouseArea`].
